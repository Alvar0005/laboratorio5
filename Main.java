...
class Scoreboard{
    ...
    } //validar si el rut ingresado cumple las condiciones
            ...
            switch(opcion){
                case "1":
                    ...
                    if(Ranking.checkPlayer(rutA)){
                        ...
                        Ranking.registerPlayer(rutA, nombreA);
                        jugadorA=Ranking.getPlayer(rutA);
                    }
                    ...
                    if(Ranking.checkPlayer(rutB)){
                        ...
                        Ranking.registerPlayer(rutB, nombreB);
                        jugadorB=Ranking.getPlayer(rutB);
                    }
                    ...
                    switch(op2){
                        case "1":
                            ...
                            if(!Ranking.checkPlayer(rut)){
                                Ranking.registerPlayer(rut, nombre);
